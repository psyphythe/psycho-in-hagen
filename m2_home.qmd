...
Standardfehler für *Anteil*
$$\sigma_{Anteil} = \sqrt{\frac{p(1-p)}{n}}$$

Standardfehler für *Mittelwert*
$$\hat{\sigma}_{\bar{x}} = \frac{\hat{\sigma}}{\sqrt{n}}$$
$\hat{\sigma}$ ist der Standardfehler der Population, $\hat{\sigma}_x$ der Stichprobe
